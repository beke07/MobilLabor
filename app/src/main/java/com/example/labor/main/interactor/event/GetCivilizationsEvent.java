...
public class GetCivilizationsEvent {
    private int code;
    private List<Civilization> civilizations;
    private Throwable throwable;

    public GetCivilizationsEvent() {
    }

    public GetCivilizationsEvent(int code, List<Civilization> civilizations, Throwable throwable) {
        this.code = code;
